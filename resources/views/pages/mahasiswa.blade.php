...
<section class="content-header">
	<h1>
		Data Mahasiswa
		<small>Informasi mengenai data mahasiswa</small>
	</h1>
	<ol class="breadcrumb">
...
<section class="content">
	<div class="box">
      ...
      <br>
			...
			<a href="{{route('mahasiswa.create')}}" class="btn btn-primary" onclick="tambahData()"><i class="fa fa-plus"></i> Tambah Data</a>
...
$.ajaxSetup({
  ...
  function editData(id) {
    document.location.href="{{url('mahasiswa')}}"+"/"+id+"/edit";
  }
