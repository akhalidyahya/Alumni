...
<section class="content-header">
	<h1>
		Detail Data Alumni
		<small>Form Detail Data ALumni</small>
	</h1>
	<ol class="breadcrumb">
...
<section class="content">
	<div class="box">
		...
		<!-- /.box-header -->
		<div class="box-body">
        <form class="form-horizontal" method="post" action="{{ url('alumni/'.$data->id) }}">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input required value="{{$data->skripsi}}" name="skripsi" type="text" class="form-control" placeholder="Judul Skripsi">
            </div>
          </div> <!-- /form group -->
          <div class="form-group">
